(function(){
   ...
   function factory(type, Collector) {
      ...
      Comparator.prototype.compareNode = function(left, right) {
         ...
         if (right.nodeName.toLowerCase() == left.nodeName.toLowerCase() && left.nodeType == right.nodeType) {
   ...
   if((this || (0,eval)('this')).document) {
      define(['./node_types', './collector'], function(node_types, Collector) {
         return function(a, b, options) {
            var Comparator = factory(node_types, collector);
      ...
      module.exports = function(a, b, options) {
         var Comparator = factory(type, Collector);
