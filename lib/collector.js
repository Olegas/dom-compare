(function(){
   ...
   function factory(type, revxpath) {
      var typeMap = {},
          comparatorTypeMap = {};
      ...
      Collector.prototype.getResult = function() {
         console.warn('getResult() is deprecated. Please, use equals() instead.');
         return this.equals();
      };

      Collector.prototype.equals = function() {
   ...
   if((this || (0,eval)('this')).document) {
      define(['./node_types', './revxpath'], function(node_types, revxpath) {
         return factory(node_types, revxpath)
      });
   }
   else {
      var type = require('./node_types');
      var revxpath = require('./revxpath');
      module.exports = factory(type, revxpath);
   }
